...
public class Find extends JFrame implements ActionListener {
	...
	public Find(Login login) {
		...
		tfCode.setFont(new Font("나눔고딕", Font.BOLD, 12));
		...
		btnSendPw.setFont(new Font("나눔고딕", Font.BOLD, 10));
