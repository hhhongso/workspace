				...
				<div id="span-company" class="sqs-block">
					<div>
						...
						<p class="xans-element- xans-layout xans-layout-footer">
							<span>Company : 퓨즈 서울(FUSE SEOUL)</span> | <span>CEO : 김수정</span>
							<span>Business Register : [414-14-00870]</span> <br> <span>On-Line
								Register : 2018-경기안산-1123</span> | <span><a href="#none"
								onclick="window.open('http://www.ftc.go.kr/bizCommPop.do?wrkr_no=4141400870', 'bizCommPop', 'width=750, height=950;');return false;">[사업자정보확인]</a></span>
							<br> <span>Tel : 031-8042-2345</span> | <span class="">E-mail
								: orge13@naver.com</span> <br> <span>Address : 15359 경기도
								안산시 단원구 고잔2길 16 (고잔동) 에머랄드빌딩 409호<br> <font color="red">반품주소지:경기도
									시흥시 소망공원로 236 (정왕동) CJ대한통운 경기시흥공단대리점 퓨즈서울 앞</font>
							</span> <br> <span class="">개인정보관리책임자 : <a
								href="mailto:orge13@naver.com">조은유</a></span>
						</p>
					</div>
				</div>
			</div>
