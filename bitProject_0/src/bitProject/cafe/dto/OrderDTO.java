...
public class OrderDTO implements Serializable, CafeDTO {
	...
	private ArrayList<OrderDTO> orderArr;
	...
	public OrderDTO(ArrayList<OrderDTO> orderArr, Status status) {
		this.orderArr = orderArr;
		this.status = status;
	}

	public ArrayList<OrderDTO> getOrderArr() {
		return orderArr;
	}

	public void setOrderArr(ArrayList<OrderDTO> orderArr) {
		this.orderArr = orderArr;
	}
